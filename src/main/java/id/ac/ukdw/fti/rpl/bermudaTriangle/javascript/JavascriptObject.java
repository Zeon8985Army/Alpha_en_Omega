 ...
 */
package id.ac.ukdw.fti.rpl.bermudaTriangle.javascript;
...
public class JavascriptObject {
     ...
     * @param stringRepresentation A string representation of the object, which can
     *                             be executed by the Javascript runtime.
     */
     ...
     * @param isArray boolean to indicate the an array is to be used as the
     *                parameter rather than breaking up into individual parameters.
     *
     */
    ...
    /**
     * Gets the name of the next variable which will be the objectname plus a unique
     * number
     *
    ...
    /**
     * Sets a property on this Javascript object for which the value is a Javascript
     * object itself.
     *
     ...
     * JavascriptEnum
     * 
     * The value is set to what is returned by the getEnumValue() method on the
     * JavascriptEnum
     *
     * @param propertyName  The name of the property.
     * @param propertyValue The value of the property.
    ...
    /**
     * JSObject will return the String "undefined" at certain times, so we need to
     * make sure we're not getting a value that looks valid, but isn't.
     * 
    ...
    /**
     * Checks a returned Javascript value where we expect a boolean but could get
     * null.
     * 
     * @param val The value from Javascript to be checked.
