 ...
 * {@link id.ac.ukdw.fti.rpl.bermudaTriangle.javascript.object.GoogleMap} class
 * to register an instance of the {@link GFXEventHandler} interface against a
 * certain event type in the Google Maps event model. See addUIEventHandler and
 ...
 * <p>
 * {@link id.ac.ukdw.fti.rpl.bermudaTriangle.javascript.object.GoogleMap#addUIEventHandler}
 * <p>
 * <blockquote>
 * 
 * <pre>
 ...
 * </blockquote>
 * <p>
 * {@link id.ac.ukdw.fti.rpl.bermudaTriangle.javascript.object.GoogleMap#addStateEventHandler}
 * <p>
 * <blockquote>
 * 
 * <pre>
...
public class EventHandlers {
     ...
     * callback key, and the event object. The current implementation is receiving
     * the LatLng object that the Javascript MouseEvent contains.
     * <p>
     * It may be more useful to return the MouseEvent and let clients go from there,
     * but there is only the stop() method on the MouseEvent?
     *
    ...
    /**
     * This method is called from Javascript, passing in the previously created
     * callback key. It uses that to find the correct handler and then passes on the
     * call. State events in the Google Maps API don't pass any parameters.
     *
     * @param callbackKey Key generated by the call to registerHandler.
     */
