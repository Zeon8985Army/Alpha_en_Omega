...
public class MVCArray extends JavascriptObject {
    ...
    /**
     * Iterates over the elements within the array, calling the supplied function
     * for each member. The parameters to the callback function are: func(element,
     * index)
     *
     * @param func
     */
    ...
    /**
     * Returns a JSObject representing the underlying array. Not entirely sure how
     * useful this would be for people.
     *
     * @return
     */
    ...
    /**
     * Adds the supplied element onto the end of the array, then returns the length
     * of the array.
     *
