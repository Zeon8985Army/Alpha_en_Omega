...
/**
 * Options for setting an InfoWindow on a Map. This class corresponds to
 * <a href=
 * "https://developers.google.com/maps/documentation/javascript/reference#InfoWindowOptions">google.maps.InfoWindowOptions"</a>
...
public class InfoWindowOptions extends JavascriptObject {
    ...
    /**
     * Maximum width of the infowindow, regardless of content's width. This value is
     * only considered if it is set before a call to open. To change the maximum
     * width when changing content, call close, setOptions, and then open.
     * 
