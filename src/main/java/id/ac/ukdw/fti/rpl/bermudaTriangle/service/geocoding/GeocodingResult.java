...
public class GeocodingResult extends JavascriptObject {
    ...
    /**
     * partial_match: boolean,postcode_localities[]: string, geometry: { location:
     * LatLng, location_type: GeocoderLocationType viewport: LatLngBounds, bounds:
     * LatLngBounds }
     */
    ...
    public List<String> getPostcodeLocalities() {
        ...
        List<JSObject> jsLocalities = GeocoderUtils
                .getJSObjectsFromArray((JSObject) jsObject.getMember("postcode_localities"));
