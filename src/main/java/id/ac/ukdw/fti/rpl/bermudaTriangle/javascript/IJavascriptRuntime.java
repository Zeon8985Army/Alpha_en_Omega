...
public interface IJavascriptRuntime {
     ...
     * @return A string which can be passed to the JavaScript environment to create
     *         a new object.
     */
    String getConstructor(String javascriptObjectType, Object... args);

    /**
     * Gets an array parameter constructor as a String, which then can be passed to
     * the execute() method. Note, this is where the parameter to the constructor is
     * an array, rather than the varargs which are broken down into separate
     * parameters.
     *
     * @param javascriptObjectType type The type of JavaScript object array to
     *                             create
     ...
     * @return A string which can be passed to the JavaScript environment to invoke
     *         the function
     */
    ...
    /**
     * Gets an array function as a String, which then can be passed to the execute()
     * method.
     * 
     * @param function The function to invoke
