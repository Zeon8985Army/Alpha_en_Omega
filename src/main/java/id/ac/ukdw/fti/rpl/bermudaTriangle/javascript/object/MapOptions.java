...
/**
 * @see <a href=
 *      "https://developers.google.com/maps/documentation/javascript/3.exp/reference#MapOptions">Google
 *      MapOptions API Documentation</a>
 * @author robt
 */
public class MapOptions extends JavascriptObject {
     ...
     * "stylers":[{"saturation":-100},{"visibility":"simplified"}]},{"featureType":
     * "road.arterial","stylers":[{"saturation":-100},{"lightness":30},{"visibility"
     * :"on"}]},{"featureType":"road.local","stylers":[{"saturation":-100},{
     * "lightness":40},{"visibility":"on"}]},{"featureType":"transit","stylers":[{
     * "saturation":-100},{"visibility":"simplified"}]},{"featureType":
     * "administrative.province","stylers":[{"visibility":"off"}]},{"featureType":
     * "water","elementType":"labels","stylers":[{"visibility":"on"},{"lightness":-
     * 25},{"saturation":-100}]},{"featureType":"water","elementType":"geometry",
     ...
     *                    calling eval() and should be of the format:
    ...
    /**
     * Sets the gestureHandling option, used to control how Google Maps deals with
     * touch screen devices. We offer no warranty as to whether this actually works
     * given that any touch events are being passed through JavaFX WebView to the
     * map, and vital information may be lost in transmission/translation.
     * <p>
     * See <a href=
     * "https://developers.google.com/maps/documentation/javascript/interaction">Google
     * Maps API - Controlling Zoom and Pan</a>
     * 
