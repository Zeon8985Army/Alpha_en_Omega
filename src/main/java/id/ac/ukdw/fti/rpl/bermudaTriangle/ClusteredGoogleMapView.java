...
import id.ac.ukdw.fti.rpl.bermudaTriangle.javascript.object.ClusteredGoogleMap;
...
public class ClusteredGoogleMapView extends GoogleMapView {
    ...
    protected String getHtmlFile(boolean debug) {
        return debug ? "html/clustered/maps_clustered_debug.html" : "html/clustered/maps_clustered.html";
    }
