...
package id.ac.ukdw.fti.rpl.bermudaTriangle.zoom;
...
public class MaxZoomService extends JavascriptObject {
    ...
    public void getMaxZoomAtLatLng(LatLong loc, MaxZoomServiceCallback callback) {
        ...
        StringBuilder r = new StringBuilder(getVariableName()).append(".").append("getMaxZoomAtLatLng(")
                .append(loc.getVariableName()).append(", ").append("function(result) {document.")
                .append(getVariableName()).append(".processResponse(result);});");
