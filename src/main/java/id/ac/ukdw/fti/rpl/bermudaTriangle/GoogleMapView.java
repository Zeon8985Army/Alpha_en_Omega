...
import id.ac.ukdw.fti.rpl.bermudaTriangle.javascript.JavaFxWebEngine;
...
public class GoogleMapView extends AnchorPane {
     ...
     * for the html page and markers. The map html page must be sourced from the jar
     * containing any marker images for those to function.
     * <p>
     ...
     * <p>
     * Your marker images should be stored in the same folder as, or below the map
     * file. You then reference them using relative notation. If you put them in a
    ...
    /**
     * Creates a new map view and specifies if the FireBug pane should be displayed
     * in the WebView
     *
     * @param mapResourcePath
     * @param debug           true if the FireBug pane should be displayed in the
     *                        WebView.
     */
     ...
     * Creates a new map view and specifies the display language and API key.
     * <p>
     * If you are specifying your own HTML page for mapResourcePath in a jar of your
     * own then you should include a script element to pull in the Google Maps API
     * with any API keys, language and region parameters.
     *
     * @param mapResourcePath
     * @param language        map display language, null for default
     * @param region
    ...
    private void initialiseScript() {
        if (!usingCustomHtml) {
            ...
            String script = "loadMapLibrary('" + GOOGLE_MAPS_API_VERSION + "','" + key + "','" + language + "','"
                    + region + "');";
        ...
        webEngine.getLoadWorker().stateProperty().addListener(
                (ObservableValue<? extends Worker.State> observable, Worker.State oldValue, Worker.State newValue) -> {
                    ...
                    if (newValue == Worker.State.SUCCEEDED) {
                        ...
                        Text styleContent = document
                                .createTextNode("* { font-family: Arial, Helvetica, san-serif !important; }");
