 ...
 */
package id.ac.ukdw.fti.rpl.bermudaTriangle.shapes;
...
public class ArcBuilder {
    ...
    /**
     * Generates the points for an arc based on two bearings from a centre point and
     * a radius.
     *
     ...
     *         Using this method directly you will need to push the centre point
     *         onto the array in order to close it, if desired.
     */
