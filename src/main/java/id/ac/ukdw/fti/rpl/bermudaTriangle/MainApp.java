...
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.elevation.ElevationResult;
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.elevation.ElevationService;
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.elevation.ElevationServiceCallback;
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.elevation.ElevationStatus;
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.elevation.LocationElevationRequest;
import id.ac.ukdw.fti.rpl.bermudaTriangle.javascript.event.UIEventType;
import id.ac.ukdw.fti.rpl.bermudaTriangle.javascript.object.Animation;
...
import id.ac.ukdw.fti.rpl.bermudaTriangle.javascript.object.LatLongBounds;
import id.ac.ukdw.fti.rpl.bermudaTriangle.javascript.object.MVCArray;
...
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.directions.DirectionsWaypoint;
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.directions.TravelModes;
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.geocoding.GeocoderStatus;
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.geocoding.GeocodingResult;
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.geocoding.GeocodingService;
import id.ac.ukdw.fti.rpl.bermudaTriangle.service.geocoding.GeocodingServiceCallback;
import id.ac.ukdw.fti.rpl.bermudaTriangle.shapes.ArcBuilder;
import id.ac.ukdw.fti.rpl.bermudaTriangle.shapes.Circle;
import id.ac.ukdw.fti.rpl.bermudaTriangle.shapes.CircleOptions;
import id.ac.ukdw.fti.rpl.bermudaTriangle.shapes.Polygon;
import id.ac.ukdw.fti.rpl.bermudaTriangle.shapes.PolygonOptions;
import id.ac.ukdw.fti.rpl.bermudaTriangle.shapes.Polyline;
import id.ac.ukdw.fti.rpl.bermudaTriangle.shapes.PolylineOptions;
import id.ac.ukdw.fti.rpl.bermudaTriangle.shapes.Rectangle;
import id.ac.ukdw.fti.rpl.bermudaTriangle.shapes.RectangleOptions;
 ...
 */
public class MainApp extends Application implements MapComponentInitializedListener, ElevationServiceCallback,
    ...
    public void mapInitialized() {
        ...
        map.addUIEventHandler(poly, UIEventType.click, (JSObject obj) -> {
            ...
            // ll.getLatitude() + " lng: " + ll.getLongitude());
        });
        ...
        PolygonOptions polygOpts = new PolygonOptions().paths(pmvc).strokeColor("blue").strokeWeight(2).editable(false)
