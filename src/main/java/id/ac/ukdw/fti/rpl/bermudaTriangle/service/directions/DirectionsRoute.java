...
public class DirectionsRoute extends JavascriptObject {
    ...
    public List<DirectionsLeg> getLegs() {
        ...
        List<JSObject> jsLocalities = GeocoderUtils.getJSObjectsFromArray((JSObject) getJSObject().getMember("legs"));
    ...
    public List<LatLong> getOverviewPath() {
        ...
        List<JSObject> jsLocalities = GeocoderUtils
                .getJSObjectsFromArray((JSObject) getJSObject().getMember("overview_path"));
        for (JSObject jsLocality : jsLocalities) {
